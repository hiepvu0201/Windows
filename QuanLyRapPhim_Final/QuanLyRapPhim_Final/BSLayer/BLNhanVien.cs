...
namespace QuanLyRapPhim_Final.BSLayer
{
    class BLNhanVien
    {
        ...
        public bool ThemNhanVien(string MaNV, string HovaTenLotNV, string TenNV, ref string err)
        {
            string sqlString =
                $"Insert Into NhanVien Values " +
                "( " + " '" + MaNV + " ' ,N'" + HovaTenLotNV + "',N' " + TenNV + "') ";
        ...
        {
            string sqlString = "Update NhanVien Set TenNV=N'" + TenNV + "' Where MaNV='" + MaNV + "'";
            return db.MyExecuteNonQuery(sqlString, CommandType.Text, ref err);
        }
    }
}
