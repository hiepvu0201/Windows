...
namespace QuanLyRapPhim_Final {
    ...
    public partial class QuanLyRapPhimDataSet_NHANVIEN : global::System.Data.DataSet {
        ...
        public partial class NhanVienDataTable : global::System.Data.TypedTableBase<NhanVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public NhanVienRow AddNhanVienRow(string HovaLotNV, string TenNV, string MaNV) {
    ...
    public partial class NhanVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[NhanVien] WHERE (([HovaLotNV] = @Original_HovaLotNV) AND ([Ten" +
                "NV] = @Original_TenNV) AND ([MaNV] = @Original_MaNV))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[NhanVien] ([HovaLotNV], [TenNV], [MaNV]) VALUES (@HovaLotNV, @" +
                "TenNV, @MaNV);\r\nSELECT HovaLotNV, TenNV, MaNV FROM NhanVien WHERE (MaNV = @MaNV)" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhanVien] SET [HovaLotNV] = @HovaLotNV, [TenNV] = @TenNV, [MaNV] = @MaNV WHERE (([HovaLotNV] = @Original_HovaLotNV) AND ([TenNV] = @Original_TenNV) AND ([MaNV] = @Original_MaNV));
SELECT HovaLotNV, TenNV, MaNV FROM NhanVien WHERE (MaNV = @MaNV)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT HovaLotNV, TenNV, MaNV FROM dbo.NhanVien";
        ...
        public virtual int Delete(string Original_HovaLotNV, string Original_TenNV, string Original_MaNV) {
        ...
        public virtual int Insert(string HovaLotNV, string TenNV, string MaNV) {
            if ((HovaLotNV == null)) {
        ...
        public virtual int Update(string HovaLotNV, string TenNV, string MaNV, string Original_HovaLotNV, string Original_TenNV, string Original_MaNV) {
            if ((HovaLotNV == null)) {
                throw new global::System.ArgumentNullException("HovaLotNV");
            }
            else {
            ...
            if ((Original_HovaLotNV == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Original_HovaLotNV));
            }
            if ((Original_TenNV == null)) {
                throw new global::System.ArgumentNullException("Original_TenNV");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string HovaLotNV, string TenNV, string Original_HovaLotNV, string Original_TenNV, string Original_MaNV) {
            return this.Update(HovaLotNV, TenNV, Original_MaNV, Original_HovaLotNV, Original_TenNV, Original_MaNV);
        }
    }
